...
if (isset($_POST['update_item_subcat'])) {
        $message = ($sql->db_Update("aacgc_itemlist_subcat", "item_subcat_cat='".$_POST['item_subcat_cat']."', item_subcat_name='".$_POST['item_subcat_name']."', item_subcat_details='".$_POST['item_subcat_details']."' WHERE item_subcat_id='".$_POST['id']."' ")) ? "Successful updated" : "Update failed";
}
...
if ($action == "") {
        ...
        <td style='width:50%' class='forumheader3'>Sub-Category Details</td>
